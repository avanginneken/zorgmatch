...
const SCORES_CONFIG = [
  { key: 'duidelijkheid_vraag', label: 'Duidelijkheid van de zorgvraag', omschrijving: 'Hoe helder was de zorgbehoefte omschreven?' },
  { key: 'respectvolle_omgang', label: 'Respectvolle omgang', omschrijving: 'Respectvolle en vriendelijke behandeling' },
  { key: 'bereikbaarheid', label: 'Bereikbaarheid', omschrijving: 'Goed bereikbaar voor afstemming en contact' },
]
...
export default function ZorgverlenerReviewPage() {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Uw beoordeling is ontvangen. De zorgvrager kan deze pas zien nadat ook zij een beoordeling hebben ingediend.
          </p>
          <button
            onClick={() => router.push('/zorgverlener/mijn-opdrachten')}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Beoordeel de zorgvrager</h1>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        ...
        <textarea
          ...
          rows={4}
          maxLength={1000}
          placeholder="Beschrijf uw samenwerking met de zorgvrager..."
